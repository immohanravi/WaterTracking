...
public class customerDataHelper extends SQLiteOpenHelper {
    ...
    public void createCustomTables(String TABLE_NAME) {
        ...
        try {
            String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + KEY_Date + " DATETIME, " + KEY_No_of_cans + " INTEGER, " + KEY_Price + " INTEGER, " + KEY_Price + " INTEGER)";
